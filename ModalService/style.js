...
function open(obj) {
    ...
    function del() {
        $('#mry-opo').append('<a href="javascript:void(0)" deletes="mry-opo" style="position:absolute;right:10px;top:6px;color:#fff;font-size:12px;"><img src="ModalService/x.png" width="18" height="18" style="margin-top:5px;margin-right:8px;"/></a>');
